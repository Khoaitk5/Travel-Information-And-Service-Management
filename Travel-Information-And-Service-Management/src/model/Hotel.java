...
public class Hotel extends BaseModel {
    ...
    public Hotel(int hotelAvailableRooms, ArrayList<String> hotelService, LocalTime hotelCheckInTime, LocalTime hotelCheckOutTime, int travelId, String travelName, Address travelLocation, String travelDescription, int rating, BigDecimal pricePerPerson, String travelContactPhone, String travelContactEmail) {
